...
extern "C" {
	...
	DLLEXPORT int makeCompSolid(WolframLibraryData libData, mint Argc, MArgument *Args, MArgument res);
	DLLEXPORT int makeSolid(WolframLibraryData libData, mint Argc, MArgument *Args, MArgument res);
	DLLEXPORT int makeShell(WolframLibraryData libData, mint Argc, MArgument *Args, MArgument res);
